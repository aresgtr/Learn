...
public class Tank {
    ...
    public void draw(Graphics g) {
        ...
        switch (gun_dir) {
            ...
            case RU:
                ...
                break;
            case R:
                g.drawImage(tank_images.get("R"), x, y, null);
                break;
            case RD:
                g.drawImage(tank_images.get("RD"), x, y, null);
                break;
            case D:
                g.drawImage(tank_images.get("D"), x, y, null);
                break;
            case LD:
                g.drawImage(tank_images.get("LD"), x, y, null);
                break;
        }
        move();
        if (isjust)
    ...
    public Bullet fire(Direction gun_dir) {
        ...
        switch (gun_dir) {
            ...
            case LU:
                ...
                break;
            case U:
                bx = x + Tank.TANKSIZE_W / 2 - 5;
                by = y;
                break;
            case RU:
                bx = x + Tank.TANKSIZE_W;
                by = y;
                break;
            case R:
                bx = x + Tank.TANKSIZE_W;
    ...
    public void keyReleased(KeyEvent e) {
        ...
        else if (key == KeyEvent.VK_2) if (islive == false) {
            islive = true;
            life = 100;
        }
        ;
