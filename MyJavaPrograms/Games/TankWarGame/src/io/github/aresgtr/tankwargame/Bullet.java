...
public class Bullet {
    ...
    public void draw(Graphics g) {
        ...
        switch (dir) {
            case L:
                g.drawImage(bullet_images.get("L"), x, y, null);
                break;
            case LU:
                g.drawImage(bullet_images.get("LU"), x, y, null);
                break;
            case U:
                g.drawImage(bullet_images.get("U"), x, y, null);
                break;
            case RU:
                g.drawImage(bullet_images.get("RU"), x, y, null);
                break;
            case R:
                g.drawImage(bullet_images.get("R"), x, y, null);
                break;
            case RD:
                g.drawImage(bullet_images.get("RD"), x, y, null);
                break;
            case D:
                g.drawImage(bullet_images.get("D"), x, y, null);
                break;
            case LD:
                g.drawImage(bullet_images.get("LD"), x, y, null);
                break;
        }
        move();
    }
